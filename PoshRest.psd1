#
# Module manifest for module 'PoshRest'
#
# Generated by: alain
#
...
@{
  ...
  GUID                  = 'b59a2214-6b2c-4015-99eb-ab853b5437f0'
  ...
  Description           = 'A module for working with HTTP RESTful APIs.'
  ...
  PrivateData           = @{
    PSData = @{
      ...
      Tags         = 'PowerShell', 'PoshRest', 'HTTP', 'alain'

      # A URL to the license for this module.
      LicenseUri   = 'https://alain.mit-license.org/'

      # A URL to the main website for this project.
      ProjectUri   = 'https://github.com/chadnpc/PoshRest'
